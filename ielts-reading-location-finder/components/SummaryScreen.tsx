                ...
                {answers.map((answer, index) => {
                  ...
                  return (
                    <tr key={index} className={answer.isCorrect ? 'bg-green-50' : 'bg-red-50'}>
                      <td className="px-4 py-3 text-sm font-medium text-slate-900">Q{question?.text.replace('Q', '')}</td>
                      <td className="px-4 py-3 text-sm text-slate-700 font-mono">{answer.userLocation || '-'}</td>
                      <td className="px-4 py-3 text-sm text-slate-700 font-mono">{question?.correctLocation}</td>
